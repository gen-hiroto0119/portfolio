  ...
  const rootClassName = useMemo(
    () =>
      [
        ...
        fadeOut && fadeOutMode === "overlay" && "logoloop--fade",
        fadeOut && fadeOutMode === "mask" && "logoloop--fade-mask",
        scaleOnHover && "logoloop--scale-hover",
        className,
      ]
        .filter(Boolean)
        .join(" "),
    [isVertical, fadeOut, fadeOutMode, scaleOnHover, className],
  );
